          ...
          random_array.list_mut().push(
            Box::new(
              Sphere::new(
                &center,
                0.2,
                Arc::new(Lambertian::new(&Vec3::new(fastrand::f32()*fastrand::f32(), fastrand::f32() * fastrand::f32(), fastrand::f32() * fastrand::f32())))
              )
            )
          );
          ...
          random_array.list_mut().push(
            Box::new(
              Sphere::new(
                &center,
                0.2,
                Arc::new(Metal::new(&Vec3::new(0.5 * (1.0 + fastrand::f32()), 0.5 * (1.0 + fastrand::f32()), 0.5 * (1.0 + fastrand::f32())), 0.5 * fastrand::f32()))
              )
            )
          )
        } else {
